...
\title{IMPORTANCE OF DETECTION OF GRAVITATIONAL WAVES AND THEIR APPLICATIONS}
\author{ Ajith U Shanbhag \\ Aditya Srivatsa}
\date{\today}
\usepackage{amsmath}
\begin{document}
...
\newpage
\section{Uses of their Detection}
...
\subsection{Information about the Big Bang}
...
\subsection{Test the theory of General Relativity}
...
\subsection{Detection of the Hubble Constant}
...
\vspace{1cm}
\includegraphics[scale=2]{HCGW.jpg}
...
\includegraphics[scale=0.2]{GWPolarisation.png}

\subsection{Centrifuge of Binary Stars}
...
\subsection{Spiralling of Black Holes and Neutron Stars}
...
\bibitem{}Gravitational wave astronomy by B F Shultz (1999)
\bibitem{}Probing the theory of gravity with gravitational lensing of gravitational waves and galaxy surveys by Suvodip Mukherjee, Benjamin D Wandelt \& Joseph Silk (2020)
\end{thebibliography}
